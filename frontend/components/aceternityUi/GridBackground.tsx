...
export function GridBackground() {
  return (
    <div className="h-[50rem] w-full dark:bg-purple-200 bg-white  dark:bg-grid-white/[0.02] bg-grid-black/[0.2] absolute top-0 left-0 flex items-center justify-center">
